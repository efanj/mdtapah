...
$(document).ready(function () {
  ...
  var benchmark = $("#rent-benchmark").DataTable({
    pageLength: 5,
    lengthMenu: [
      [5, 15, 25, 50],
      [5, 15, 25, 50]
  ...
  $("#rent-benchmark tbody").on("click", "td.details-control", function () {
  ...
  $("#rent-benchmark").css("font-size", 13)

  $("#form-rent-benchmark").submit(function (e) {
    e.preventDefault()
    ajax.send("Vendor/insertrentbenchmark", helpers.serialize(this), rentBenchMarkCallBack)
  })
