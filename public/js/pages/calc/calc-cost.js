$(document).ready(function () {
  ...
  function addRowBuilding(benchmark, lsans, lsbgnt, lsanst) {
    var Id = "0"
    var tableId = "zero"
    var rowId
    // tableBody = $(".section table#" + tableId + " tbody")

    if (lsbgnt != "" && lsbgnt > 0) {
      var addedbgnt = document.querySelectorAll("tbody#" + tableId + " tr").length
      rowId = addedbgnt + 1
      var row = '<tr id="' + Id + '"><td><input type="text" class="form-control input-xs" name="section[' + Id + "][item][" + rowId + '][title]" value="MFA - Tambahan"></td>'
      row += '<td><input type="number" class="form-control input-xs" name="section[' + Id + "][item][" + rowId + '][breadth]" id="breadth" min="0" value="' + lsbgnt + '"></td>'
      row += '<td><select class="form-control input-xs" name="section[' + Id + "][item][" + rowId + '][breadthtype]">'
      row += "<option value=''>Sila Pilih</option>"
      row += '<option value="mp" selected>Meter</option>'
      row += '<option value="ft">Kaki</option>'
    ...
    if (lsans != "" && lsans > 0) {
      var addedans = document.querySelectorAll("tbody#" + tableId + " tr").length
      rowId = addedans + 1
      var row = '<tr id="' + Id + '"><td><input type="text" class="form-control input-xs" name="section[' + Id + "][item][" + rowId + '][title]" value="AFA"></td>'
      row += '<td><input type="number" class="form-control input-xs" name="section[' + Id + "][item][" + rowId + '][breadth]" id="breadth" min="0" value="' + lsans + '"></td>'
      row += '<td><select class="form-control input-xs" name="section[' + Id + "][item][" + rowId + '][breadthtype]">'
      row += "<option value=''>Sila Pilih</option>"
      row += '<option value="mp" selected>Meter</option>'
      row += '<option value="ft">Kaki</option>'
    ...
    if (lsanst != "" && lsanst > 0) {
      var addedanst = document.querySelectorAll("tbody#" + tableId + " tr").length
      rowId = addedanst + 1
      // console.log(lsanst)
      var row = '<tr id="' + Id + '"><td><input type="text" class="form-control input-xs" name="section[' + Id + "][item][" + rowId + '][title]" value="AFA - Tambahan"></td>'
      row += '<td><input type="number" class="form-control input-xs" name="section[' + Id + "][item][" + rowId + '][breadth]" id="breadth" min="0" value="' + lsanst + '"></td>'
      row += '<td><select class="form-control input-xs" name="section[' + Id + "][item][" + rowId + '][breadthtype]">'
      row += "<option value=''>Sila Pilih</option>"
      row += '<option value="mp" selected>Meter</option>'
      row += '<option value="ft">Kaki</option>'
