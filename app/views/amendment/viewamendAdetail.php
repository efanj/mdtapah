    ...
    <div class="page-content-inner">
      ...
      <div class="row">
        <div class="col-lg-8 col-sm-8 col-md-8">
          <?php $hacmja = $this->controller->account->viewamendAdetail($siriNo); ?>
            ...
            <div class="panel-body">
              <form class="form-horizontal" role="form" id="form-jadualA" method="post" style="font-size:13px;">
                <div class="row mb5">
                  ...
                  <div class="col-md-3">
                    <div class="control-label tal"><?= $hacmja["mja_tkhpl"] ?></div>
                  </div>
                  <div class="col-md-2">
                    <label class="control-label">Tarikh K/Kuasa :</label>
                  </div>
                  <div class="col-md-1 tal">
                    <div class="control-label tal"><?= $hacmja["mja_tkhtk"] ?></div>
                  </div>
                  <div class="col-md-3">
                ...
                <div class="row mb5">
                  ...
                  <div class="col-md-6">
                    <div class="control-label tal"><?= $hacmja["acm_sbktr"] ?></div>
                  </div>
                </div>
                <div class="row mb5">
                  <div class="col-md-2">
                  ...
                  <div class="col-md-10">
                    <div class="control-label tal"><?= $hacmja["mja_mesej"] ?></div>
                  </div>
                </div>
                <div class="row mb5">
                  <div class="col-md-2">
                  ...
                  <div class="col-md-4 tal"><label class="control-label"><b><?= $hacmja["mja_onama"] ?> -
                        <?= $hacmja["name"] ?></b></label>
                  </div>
                </div>
                <hr>
