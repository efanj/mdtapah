...
<script src="<?= PUBLIC_ROOT ?>js/pages/table-handleinfops.js" type="text/javascript"></script>
<script src="<?= PUBLIC_ROOT ?>js/pages/printHandleInfo.init.js" type="text/javascript"></script>
