...
<script src="<?= PUBLIC_ROOT ?>js/pages/wizard/wizard-vendor-editcost.js" type="text/javascript"></script>
<script src="<?= PUBLIC_ROOT ?>js/pages/calc/calc-editcost.js" type="text/javascript"></script>
