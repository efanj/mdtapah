...
<script src="<?= PUBLIC_ROOT ?>js/pages/wizard/wizard-vendor-rent.js" type="text/javascript"></script>
<script src="<?= PUBLIC_ROOT ?>js/pages/calc/calc-rent.js" type="text/javascript"></script>
