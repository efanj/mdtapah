...
<script src="<?= PUBLIC_ROOT ?>js/pages/table-amendlists.js" type="text/javascript"></script>
<script src="<?= PUBLIC_ROOT ?>js/pages/print-amendlists.js" type="text/javascript"></script>
