                ...
                <div class="row">
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input class="form-control input-sm" type="text" value="<?= $info["peg_akaun"] ?>" name="noAkaun" readonly>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
                      <label>No. Lot :</label>
                      <input class="form-control input-sm" type="text" value="<?= $info["peg_nolot"] ?>" name="noLot" readonly>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
                      <label>No. PT :</label>
                      <input class="form-control input-sm" type="text" value="<?= $info["peg_nompt"] ?>" name="noPT" readonly>
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-sm-6">
                    <div class="form-group">
                      <label>Alamat</label>
                      <input type="text" class="form-control input-sm round" name="adpg1" value="<?= $info["adpg1"] ?>" />
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      <label>Jalan</label>
                      <input type="text" class="form-control input-sm round" name="adpg2" value="<?= $info["adpg2"] ?>" />
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control input-sm round" name="adpg3" value="<?= $info["adpg3"] ?>" />
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="form-group">
                      <label>Negeri</label>
                      <input type="text" class="form-control input-sm round" name="adpg4" value="<?= $info["adpg4"] ?>" />
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control input-sm round" id="tnama" value="<?= $info["tnh_tnama"] ?>" readonly />
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control input-sm round" id="bnama" value="<?= $info["bgn_bnama"] ?>" readonly />
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    <input type="text" class="form-control input-sm round" id="hnama" value="<?= $info["hrt_hnama"] ?>" readonly />
                  </div>
                  <div class="col-sm-6">
                    <label for="struktur">Struktur Bangunan</label>
                    <input type="hidden" name="snama" value="<?= $info["peg_stkod"] ?>">
                    <input type="text" class="form-control input-sm round" id="snama" value="<?= $info["stb_snama"] ?>" readonly />
                  </div>
                </div>
                <div class="form-group">
                  <div class="row">
                    <div class="col-sm-6">
                      ...
                      <input type="text" class="form-control input-sm round" id="kadar" value="<?= $info["kaw_kadar"] ?>" readonly />
                    </div>
                    <div class="col-sm-6">
                      <label for="nilth">Nilai Tahunan</label>
                      <input type="text" class="form-control input-sm round" id="nilth" value="<?= $info["peg_nilth"] ?>" readonly />
                    </div>
                  </div>
                </div>
                <div class="form-group">
