          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              <div class="table-responsive">
                <table id="cost-benchmark" class="display">
                  <thead>
                    <tr>
                      <th width="5%"></th>
                      <th width="17%">
                    ...
                    <table class="table table-bordered cost" style="font-size:13px;">
                      ...
                      <tbody id="cost-table">
                        <tr id="0">
                          ...
                          <td>
                            <input type="number" class="form-control input-sm" name="items_cost[0][costprice]" value="0" min="0.00" max="10000.00" step="0.01">
                          </td>
                          <td>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <table id="account" class="table table-bordered display" width="100%">
          <thead>
            <tr>
              <th>No. Akaun</th>
              <th>Pemilik</th>
