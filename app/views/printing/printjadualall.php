...
$rows = $this->controller->printing->datasubmition($siriNo);
...
$html .= '<tr>
      <td style="width:20%; text-align:left">Tarikh Serah : ' . $newdate . '</td>
      <td></td>
...
foreach ($rows as $row) {
  $html .= '<tr class="no-break">
        ...
        <td rowspan="2">' . $row['pmk_nmbil'] . '</br>' . $row['smk_adpg1'] . '</br>' . $row['smk_adpg2'] . '</br>' .
    $row['smk_adpg3'] . '</br>' . $row['smk_adpg4'] . '</td>
        <td rowspan="2">' . $row['smk_nolot'] . '</br>' . $row['smk_nompt'] . '</br>' . $row['pmk_hkmlk'] . '</td>
        <td rowspan="2">' . $row['peg_lstnh'] . ' mp</br>' . $row['peg_lsbgn'] . ' mp</br>' . $row['peg_lsans'] . ' mp</td>
        <td rowspan="2">' . $row['smk_lsbgn_tmbh'] . ' mp</br>' . $row['smk_lsans_tmbh'] . ' mp</td>
